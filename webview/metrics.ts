          ...
          ? html`
              <div class="guide-content">
                <dl>
                  ...
                  <dd>Tokens generated by the model (its response). Always billed at the full output rate.</dd>
                  ...
                  <dt>Total Tokens</dt>
                  <dd>Sum of all token types: output + input + cache read + cache creation. This is the total volume of tokens processed across all requests.</dd>
                </dl>
              </div>
            `
          : null}
